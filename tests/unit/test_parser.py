...
class TestCOTAHISTParser:
    ...
    def test_instrument_filter_options(self, parser, tmp_path):
        ...
        # Stock line (010)
        stock_line = (
            "012025121702PETR4       010PETROBRAS   PN      N2   R$  000000000308600000000031080000000003082000000000309500000000031080000000003107000000000310841804000000000039337100000000121770129400000000000000009999123100000010000000000000BRPETRACNPR6222"
            + " " * 23
            + "\n"
        )
        ...
        # Option line (070)
        option_line = (
            "012025121778PETRL255    070PETROBRAS   PN      N2000R$  000000000029020000000002902000000000290200000000029020000000002902000000000000000000000000000004000000000000028438500000000002843850000000025580202602190000000010000000000000BRPETRACNPR6222"
            + " " * 23
            + "\n"
        )
